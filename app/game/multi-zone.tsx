...
export default function MultiZoneGame() {
    ...
    // Fix for finishRound causing async state update issue for final calc:
    // Actually accumulatedMs won't be updated immediately in the same closure.
    // So we should handle 'result' state transition carefully or use a ref for total score if we needed immediate access.
    // But for rendering the ResultView, the component re-render will see updated accumulatedMs.
